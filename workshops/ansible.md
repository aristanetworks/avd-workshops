...
Ultimately, Ansible Roles can be seen as a blueprint to not only automate, but standardize, our repeatable tasks; Complete with a toolbox containing all the necessary tools to get the job done.
